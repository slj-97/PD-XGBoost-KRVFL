...
%% KRVFL评估
fprintf('\n=== 基于PSO优化的KRVFL特征评估（训练集优化，最少保留10个特征） ===\n');
config = struct(...
    'kernelType', 'poly', ...
    'xi', 0.01, ...
    'swarmSize', 20, ...
...
[optimalFeatures, results, best_params] = evaluateWithKRVFL(...
...
%% 函数：KRVFL评估
function [optimalFeatures, results, best_params] = evaluateWithKRVFL(...
